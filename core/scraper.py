...
from scrapy.utils.defer import (defer_fail, defer_succeed, iter_errback,
                                parallel)
...
class Slot:
    ...
    def add_response_request(self, result: Union[Response, Failure],
    ...
    def finish_response(self, result: Union[Response, Failure],
...
class Scraper:
    ...
    def enqueue_scrape(self, result: Union[Response, Failure],
    ...
    def _scrape(self, result: Union[Response, Failure], request: Request,
        ...
        dfd = self._scrape2(result, request,
                            spider)  # returns spider's processed output
    ...
    def _scrape2(self, result: Union[Response, Failure], request: Request,
        ...
        """
        if isinstance(result, Response):
            return self.spidermw.scrape_response(self.call_spider, result,
                                                 request, spider)
    ...
    def call_spider(self, result: Union[Response, Failure], request: Request,
                    spider: Spider) -> Deferred:
        if isinstance(result, Response):
    ...
    def handle_spider_error(self, _failure: Failure, request: Request,
                            response: Response, spider: Spider) -> None:
        exc = _failure.value
    ...
    def handle_spider_output(self, result: Iterable, request: Request,
    ...
    def _log_download_errors(self, spider_failure: Failure,
                             download_failure: Failure, request: Request,
